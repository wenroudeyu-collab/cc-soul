...
export const ROVER_PATH = resolve(DATA_DIR, 'rover.json')
export const UPGRADE_LOG_PATH = resolve(DATA_DIR, 'upgrades.json')
export const UPGRADE_STATE_PATH = resolve(DATA_DIR, 'upgrade_state.json')
...
export const UPGRADE_EXPERIENCES_PATH = resolve(DATA_DIR, 'upgrade_experiences.json')
